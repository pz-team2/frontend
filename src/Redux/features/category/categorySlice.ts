...
import { addcategory, delcategory, listcategory } from "../category/cetegoryApi";
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(deletecategory.fulfilled, (state, action) => {
                state.datacategory = state.datacategory.filter((category: category) => category._id !== action.payload);
